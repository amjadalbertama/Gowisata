...
<script type="text/javascript">
  ...
  getListOrderKaiWisataAdmin()
    ...
    function getListOrderKaiWisataAdmin(){
      ...
      var url = fetch(mainurl+'transaction/admin/list?order=desc&per_page=10&product_type=FLIGHT',{
          method: 'GET',
          headers: {
                          ...
                          <td class="text-nowrap">
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <input id="booking_code`+no+`" value="`+ tot_transaction[i].details[0].booking_data.booking_code+`" hidden></input>
                              </div>
                            </div>
                          </td>
                        </tr>
    ...
    function toDetailsTr(id){
     ...
     var code_book = $("#booking_code" + id).val()
                    ...
                    <div class="row col-12">
                      ...
                      <div class="form-group col-3" >
                          <label for="type">Type Pesanan: </label>
                               <input id="type_produkt" type="text" class="form-control " name="" placeholder="" value="Pesawat" readonly>
                          <div class="valid-feedback">Valid.</div>
                          <div class="invalid-feedback-adult text-colors-block"></div>
                      </div>
                      <div class="form-group col-3" >
                          <label for="type">Kode Booking: </label>
                               <input id="code_book_inp_depart" type="text" class="form-control " name="" placeholder="" value="`+code_book+`" readonly>
                          <div class="valid-feedback">Valid.</div>
                          <div class="invalid-feedback-adult text-colors-block"></div>
                      </div>
                      <div class="form-group col-3" >
