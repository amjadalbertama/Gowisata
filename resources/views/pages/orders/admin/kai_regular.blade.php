...
<script type="text/javascript">
  ...
  getListOrderKaiWisataAdmin()
    ...
    function getListOrderKaiWisataAdmin(){
      ...
      var url = fetch(mainurl+'transaction/admin/list?order=desc&per_page=10&product_type=TRAIN',{
          method: 'GET',
          headers: {
                    ...
                    if(tot_transaction[i].details[0].product_type == "TRAIN"){
                      if(tot_transaction[i].details[0].booking_data.train_type == "Regular"){
                        ...
                        setorder = `<tr>
                          ...
                          <td>`+ tot_transaction[i].details[0].booking_data.booking_code_gds +`<br>`+book_return+`</td>
    ...
    function toDetailsTr(id){
     ...
     var codebook = $("#code_krl_reg"+id).val()
     var codebook_return = $("#code_krl_reg_return"+id).val()
                    ...
                    <div class="row col-12">
                      ...
                      <div class="form-group col-3" >
                          <label for="type">Type Pesanan: </label>
                               <input id="type_produkt" type="text" class="form-control " name="" placeholder="" value="KAI Regular" readonly>
                          <div class="valid-feedback">Valid.</div>
                          <div class="invalid-feedback-adult text-colors-block"></div>
                      </div>
                      <div class="form-group col-3" >
                      ...
                      <div class="form-group col-3" >
                          <label for="type">Kode Booking Depart: </label>
                               <input id="code_book_inp_depart" type="text" class="form-control " name="" placeholder="" value="`+codebook+`" required readonly>
                          <div class="valid-feedback">Valid.</div>
                          <div class="invalid-feedback-adult text-colors-block"></div>
                      </div>
                      <div class="form-group col-3" >
                          <label for="type">Kode Booking Return: </label>
                               <input id="code_book_inp_return" type="text" class="form-control d-none" name="" placeholder="`+codebook_return+`" value="" required readonly>
                          <div class="valid-feedback">Valid.</div>
                          <div class="invalid-feedback-adult text-colors-block"></div>
                      </div>
                      <div class="form-group col-3" >
