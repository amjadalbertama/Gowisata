      ...
      <div class="container">
        ...
        <div class="col-12 col-md-9 pt-3">
          ...
          <div class="row mb-3">
            ...
            <label for="" class="text-colors-on"><b>Data Pesanan KAI Wisata</b></label>
            </div>
            <!-- .col -->
...
<script type="text/javascript">
  ...
  $("#kaiWisataAdmin").addClass('text-warning')
              ...
              if(transaction.data != 0 || transaction.data != null){
                  for (var i = 0; i < tot_transaction.length; i++){ 
                    if(tot_transaction[i].details[0].product_type == "TRAIN_SPEC"){
                      // if(tot_transaction[i].details[0].booking_data.train_type != undefined){

                      // }
                      if(tot_transaction[i].details[0].meta.product_type == "Kereta Wisata" && tot_transaction[i].details[0].booking_data.train_type == "Wisata"){
                        
                        if(tot_transaction[i].details[0].booking_data.booking_code !=null || tot_transaction[i].details[0].booking_data.booking_code != undefined){
                    ...
                    <div class="row col-12">
                      <div class="form-group col-4 d-none" id="code_book_inp_return">
                          <label for="type">Kode Booking Return: </label>
                               <input id="" type="text" class="form-control" name="" placeholder="" value="" required>
                          <div class="valid-feedback">Valid.</div>
                          <div class="invalid-feedback-adult text-colors-block"></div>
                      </div>
                      <div class="form-group col-4" >
                          <label for="type">Harga Satuan Gerbong: </label>
                               <input id="harga_s" type="number" step="0.01" class="form-control " name="" placeholder="Rp. `+ formatPrice(harga)+`" value="" required>
                          <div class="valid-feedback">Valid.</div>
                          <div class="invalid-feedback-adult text-colors-block"></div>
                      </div>
                      <div class="form-group col-4" >
