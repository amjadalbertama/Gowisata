        ...
        <div class="col-12 col-md-9 pt-3">
          ...
          <div class="row mb-3">
            <div class="col-12 col-md-8 col-lg-9 col-xl-9">
              <label for="" class="text-colors-on"><b>Data Pesanan KAI Istimewa</b></label>
            </div>
            <!-- .col -->
...
<script type="text/javascript">
  ...
  $("#KaiIstimewaAdmin").addClass('text-warning')
              ...
              if(transaction.data != 0 || transaction.data != null){
                  for (var i = 0; i < tot_transaction.length; i++){ 
                    if(tot_transaction[i].details[0].product_type == "TRAIN_SPEC"){
                      if(tot_transaction[i].details[0].booking_data.train_type == "Istimewa"){
                        ...
                        //   var book_return = tot_transaction[i].details[1].booking_data.booking_code;
                        // }else{
                        //   var book_return = ""
                        // }
