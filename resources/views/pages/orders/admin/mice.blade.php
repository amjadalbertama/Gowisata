        ...
        <div class="col-12 col-md-9 pt-3">
          ...
          <div class="row mb-3">
            <div class="col-12 col-md-8 col-lg-9 col-xl-9">
              <label for="" class="text-colors-on"><b>Data Pesanan MICE</b></label>
            </div>
            <!-- .col -->
...
<script type="text/javascript">
  ...
  $("#miceOrderAdmin").addClass('text-warning')
  ...
  getListOrderKaiWisataAdmin()
    ...
    function getListOrderKaiWisataAdmin(){
      ...
      var url = fetch(mainurl+'transaction/admin/list?order=desc&per_page=10&product_type=MICE',{
          method: 'GET',
          headers: {
                          ...
                          <td class="text-nowrap">
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <a id="detailsTrainWis"class="dropdown-item" href="javascript:void(0);" title="Details" onclick="toDetailsTr(`+no+`)"><i class="fa fa-info fa-fw mr-1"></i>Details Mice</a>
                                ...
                                <input id="name_loc`+no+`" value="`+ tot_transaction[i].details[0].booking_data.location_name+`" hidden></input>
                              </div>
                            </div>
                          </td>
                        </tr>
                ...
                <div class="modal-content">
                    ...
                    <b> Data Pesanan:</b>
                      <div class="row">
                        ...
                        <div class="form-group col-3" >
                            <label for="type">Type Pesanan: </label>
                                <input id="type_produkt" type="text" class="form-control " name="" placeholder="" value="MICE" readonly>
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback-adult text-colors-block"></div>
                        </div>
                        <div class="form-group col-3" >
                            <label for="type">Harga: </label>
                                <input id="harga_s" type="number" class="form-control " name="" placeholder="" value="`+harga+`" required>
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback-adult text-colors-block"></div>
                        </div>
                        <div class="form-group col-3" >
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn main-color" id="update_kaiWis" onclick="update_mice()"><b class="text-colors-off"><i class="fa fa-check mr-1" ></i>Update Pesanan</b></button>
