        ...
        <div class="col-12 col-md-9 pt-3">
          ...
          <div class="row mb-3">
            <div class="col-12 col-md-8 col-lg-9 col-xl-9">
              <label for="" class="text-colors-on"><b>Data Pesanan Pesawat</b></label>
            </div>
            <!-- .col -->
...
<script type="text/javascript">
  ...
  $("#pesawatOrderAdmin").addClass('text-warning')
  ...
  getListOrderKaiWisataAdmin()
    ...
    function getListOrderKaiWisataAdmin(){
      ...
      var url = fetch(mainurl+'transaction/list?order=desc&per_page=1000',{
          method: 'GET',
          headers: {
                  ...
                  for (var i = 0; i < tot_transaction.length; i++){ 
                    if(tot_transaction[i].details[0].product_type == "FLIGHT"){
                        ...
                        setorder = `<tr>
                          ...
                          <td>`+ tot_transaction[i].details[0].booking_data.route_type+`</td>
                          <td>`+ tot_transaction[i].invoice_number +`</td>
                          <td>`+ book +`</td>
                          <td>`+ tot_transaction[i].details[0].booking_data.user_id +`</td>
                          <td>Pesawat</td>
                    ...
                    <div class="row col-12">
                      ...
                      <div class="form-group col-3" >
                          <label for="type">Type Pesanan: </label>
                               <input id="type_produkt" type="text" class="form-control " name="" placeholder="" value="`+product_t+`" readonly>
                          <div class="valid-feedback">Valid.</div>
                          <div class="invalid-feedback-adult text-colors-block"></div>
                      </div>
                      <div class="form-group col-3" >
                      ...
                      <div class="form-group col-3" >
                          <label for="type">Kode Booking Return: </label>
                               <input id="code_book_inp_return" type="text" class="form-control d-none" name="" placeholder="" value="" required>
                          <div class="valid-feedback">Valid.</div>
                          <div class="invalid-feedback-adult text-colors-block"></div>
                      </div>
                      <div class="form-group col-3" >
