        ...
        <h1 class="h6 font-weight-normal text-center text-uppercase "> <b>List Data Companies</b> </h1><br>
          <div class="row mb-3">
            <div class="col-12 col-md-8 col-lg-9 col-xl-9">
              <a href="{{ route('add_officers') }}" class="btn btn-sm px-4 mr-2" style="background-image: linear-gradient(red, rgb(251, 140, 1));"><b class="text-white"><i class="fa fa-user-plus mr-2"></i>New Company</b></a>
