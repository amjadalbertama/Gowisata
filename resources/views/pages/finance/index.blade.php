...
$.LoadingOverlay("show")
    ...
    $("#payment_navbar_wisata" ).addClass('text-colors-on')
    ...
    var url = fetch(mainurl + 'transaction/list?id='+ id_trans +'order=desc&page=1',{
        ...
        var [dateStringPart, timeStringPart] = dateString.split(' - ');
        var [day, month, year] = dateStringPart.split('/');
        var [hour, minute] = timeStringPart.split(':');
