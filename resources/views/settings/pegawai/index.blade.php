  ...
  <div class="row" id="body-sidemenu">
    <div id="main-content" class="col with-fixed-sidebar pt-3 pb-5">
      <div class="container">
        ...
        <h1 class="h6 font-weight-normal text-center text-uppercase"> <b>List Data Pegawai</b> </h1><br>
          <div class="row mb-3">
            <div class="col-12 col-md-8 col-lg-9 col-xl-9">
              <a class="btn btn-sm px-4 mr-2 main-color" onclick="modalAddEmployer()"><b class="text-white"><i class="fa fa-user-plus mr-2"></i>New Employee</b></a>
            ...
            <div class="col-12">
              <div class="table-responsive">
                <table class="table table-striped table-sm border bg-white">
                  ...
                  <tbody class="text-nowrap" id="table_userbtb">
