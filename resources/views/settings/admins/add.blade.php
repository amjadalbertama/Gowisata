    ...
    <div class="row" id="body-sidemenu">
        <div id="main-content" class="col with-fixed-sidebar pt-3 pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                    <h1 class="h6 font-weight-normal text-center text-uppercase pt-3 "> <b>Add New Admin Business</b> </h1><br>
                        <div class="card shadow p-3 mb-5 bg-body rounded">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <!-- <form action="{{route('registerpost')}}" class="mb-30" id="form_add_user" method="POST"> -->
                                            @csrf
                                            <fieldset id="fieldset1" class="fieldsetForm">
                                                ...
                                                <div class="row">
                                                    <div class="col text-center">
                                                        <hr>
                                                        <button id="addnAdminb2b" class="btn main-color text-colors-off"><i class="fa fa-user-plus mr-2"></i><b>Save</b></button>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#addnAdminb2b').on('click', function(e){
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        toastr.success("Add New Admins Success!")
// console.log(response);
                    ...
                    // response.data.name
                        ...
                        //     $("#name").removeClass("is-valid").removeClass("border-success")
                        //     $("#name").addClass("is-invalid").addClass("border-danger")
                        //     $(".invalid-feedback-name").css("display", "block").html('This field cannot be empty!')
                        // }else{
                        //     $("#name").removeClass("is-invalid").removeClass("border-danger")
                        //     $("#name").addClass("is-valid").addClass("border-success")
                        //     $(".invalid-feedback-name").css("display", "none") 
                        ...
                        toastr.error(response.message, "Error Add New Admin Business!")
                    }
                }
            })   
        })
