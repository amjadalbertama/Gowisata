        ...
        <div class="col-12">
          <div class="card shadow-sm">
            <div class="card-body">
              <div class="row">
                <div class="col-12">
                  <form action="" class="mb-30 needs-validation" novalidate id="form_hak_akses" method="POST">
                    @csrf
                    <fieldset id="fieldset1" class="fieldsetForm">
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Masukkan nama grup hak akses..." name="name" value="{{ $group->name }}" disabled>
                                ...
                                <tr>
                                  ...
                                  <td class="pl-3">
                                    <div class="custom-control custom-radio custom-control-inline">
                                      @if($data["value"] == "all")
                                      <input type="radio" class="custom-control-input" id="{{ $data['permission'] }}-{{ $lcount }}-1" checked name="permission['{{ $data['permission'] }}']" value="all"><label class="custom-control-label" for="{{ $data['permission'] }}-{{ $lcount }}-1">&nbsp;</label>
                                      @else
                                  ...
                                  <td class="pl-3">
                                    <div class="custom-control custom-radio custom-control-inline">
                                      @if($data["value"] == "read")
                                      <input type="radio" class="custom-control-input" id="{{ $data['permission'] }}-{{ $lcount }}-2" checked name="permission['{{ $data['permission'] }}']" value="read"><label class="custom-control-label" for="{{ $data['permission'] }}-{{ $lcount }}-2">&nbsp;</label>
                                      @else
                                  ...
                                  <td class="pl-3">
                                    <div class="custom-control custom-radio custom-control-inline">
                                      @if($data["value"] == "edit")
                                      <input type="radio" class="custom-control-input" id="{{ $data['permission'] }}-{{ $lcount }}-3" checked name="permission['{{ $data['permission'] }}']" value="edit"><label class="custom-control-label" for="{{ $data['permission'] }}-{{ $lcount }}-3">&nbsp;</label>
                                      @else
                                  ...
                                  <td class="pl-3">
                                    <div class="custom-control custom-radio custom-control-inline">
                                      @if($data["value"] == "approval")
                                      <input type="radio" class="custom-control-input" id="{{ $data['permission'] }}-{{ $lcount }}-5" checked name="permission['{{ $data['permission'] }}']" value="approval"><label class="custom-control-label" for="{{ $data['permission'] }}-{{ $lcount }}-5">&nbsp;</label>
                                      @else
                                  ...
                                  <td class="pl-3">
                                    <div class="custom-control custom-radio custom-control-inline">
                                      @if($data["value"] == "reviewer")
                                      <input type="radio" class="custom-control-input" id="{{ $data['permission'] }}-{{ $lcount }}-6" checked name="permission['{{ $data['permission'] }}']" value="reviewer"><label class="custom-control-label" for="{{ $data['permission'] }}-{{ $lcount }}-6">&nbsp;</label>
                                      @else
                                  ...
                                  <td class="pl-3">
                                    <div class="custom-control custom-radio custom-control-inline">
                                      @if($data["value"] == "deny")
                                      <input type="radio" class="custom-control-input" id="{{ $data['permission'] }}-{{ $lcount }}-4" checked name="permission['{{ $data['permission'] }}']" value="deny"><label class="custom-control-label" for="{{ $data['permission'] }}-{{ $lcount }}-4">&nbsp;</label>
                                      @else
                                      <input type="radio" class="custom-control-input" id="{{ $data['permission'] }}-{{ $lcount }}-4" name="permission['{{ $data['permission'] }}']" value="deny"><label class="custom-control-label" for="{{ $data['permission'] }}-{{ $lcount }}-4">&nbsp;</label>
                                      @endif
                                    </div>
                                  </td>
                                </tr>
                      ...
                      <div class="row">
                        <div class="col text-center">
                          <hr>
                          <button id="submitButton2UpdAcc" type="submit" class="btn btn-main"><i class="fa fa-floppy-o mr-2"></i>Save</button>
...
<script>
  ...
  $('#submitButton2UpdAcc').on('click', function(e) {
    console.log('clicked')
    var token = $('meta[name="csrf-token"]').attr('content');
    $.ajax({
      url: "{{ route('updateaccess', $group->id) }}",
