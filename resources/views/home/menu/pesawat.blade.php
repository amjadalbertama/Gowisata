                    ...
                    <div class="col-9 pt-2">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                    <h1 class="h6 font-weight-normal text-center text-uppercase ">Detail Tiket Kereta</h1>
                                        <hr>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <button class="btn btn-primary btn-block col-2 md-auto top-100 start-50" id="">Buat Pesanan</button>
                                        </div>
