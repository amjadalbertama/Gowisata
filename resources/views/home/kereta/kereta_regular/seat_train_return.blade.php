                    ...
                    <div class="col-12 pt-2">
                        <div class="card shadow p-3 mb-5 bg-body rounded">
                            <div class="card-body ">
                                <div class="row">
                                    <div class="col-12">
                                        <h1 class="h5 font-weight-normal text-center text-uppercase text-colors-on"> <b>Pilih Kursi Kereta Kepulangan</b> </h5>
                                        <hr>
                                        <br>
                                        <div class="row">
                                            <div class="col-1">
...
<script>
    ...
    var url = fetch(mainurl +'train/booking_detail',{
        ...
        var train = responseData.data.return;
        console.log(train)
    ...
    var url = fetch(mainurl +'train/seat_map',{
        ...
        const seat_gerbong = responseData.data.return.seat_map;
    ...
    $("#list_gerbong").on("change", function(){
        ...
        var url = fetch(mainurl +'train/seat_map',{
            ...
            $("#map_seat").removeClass("d-none")
            let seat_gerbong = responseData.data.return.seat_map ;
                    ...
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="bottonBook" onclick="okChangeSeatReturn()"><b class="text-colors-off"><i class="fa fa-check mr-1"></i>Ya</b></button>
