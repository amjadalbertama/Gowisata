...
<script>
    ...
    var scadule_side = JSON.parse(localStorage.getItem('data_scadule_istimewa'));
    ...
    var name_kai_side = JSON.parse(localStorage.getItem('id_kai_istimewa'));

    // console.log(name_kai_side)
    $("#name_kai").replaceWith(name_kai_side[0].name_wagon);
    var cap_tot = name_kai_side[0].capa_wagon;
                ...
                <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll"> 
                            <div> Kereta: <b>Istimewa</b></div>
                            <div> Nama Kontak: <b>`+name_contact+`</b></div>
                            <div> Jadwal Keberangkatan: <b>`+scadule[0]['departure']+`</b></div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" id="bottonBook" onclick="createOrderaKaiIstimewa()"><i class="fa fa-check mr-1" ></i>Ya</button>
    ...
    function createOrderaKaiIstimewa(){
            $.LoadingOverlay("show")
            ...
            body: JSON.stringify({
                "detail_train": {
                    ...
                    detail_return,
                    "train_wagon": [name_kai_side[0]['id_wagon']]
                },
